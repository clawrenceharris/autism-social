...
export const useScenarios = () => {
  ...
  return {
    ...
    selectedScenario: scenarios.selectedScenarioId
      ? scenarios.items[scenarios.selectedScenarioId]
      : null,
    dispatch,
  };
};
export const selectScenario = (id: string) =>
  createSelector(
...
export const useDialogues = () => {
  ...
  return {
    ...
    selectedDialogue: dialogues.selectedDialogueId
      ? dialogues.items[dialogues.selectedDialogueId]
      : null,
