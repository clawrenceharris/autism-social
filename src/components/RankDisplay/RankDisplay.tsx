...
const RankUpCelebration: React.FC<RankUpCelebrationProps> = ({ newRank, onClose }) => {
  ...
  return (
    <div className="rank-up-celebration">
      <div className="celebration-content">
        ...
        <h2 className="celebration-title" style={{ '--rank-color': newRank.color } as React.CSSProperties}>
          Rank Up!
        </h2>
        
        <p className="celebration-message">
          Congratulations! Your social skills have improved and you've reached a new rank!
        </p>
...
const RankDisplay: React.FC<RankDisplayProps> = ({
  ...
  const [progress, setProgress] = useState<RankProgress>(calculateRankProgress(totalPoints));
  ...
  useEffect(() => {
    if (previousPoints !== undefined && hasRankedUp(previousPoints, totalPoints)) {
      setShowRankUp(true);
    }
  ...
  return (
    <>
      <div className={`rank-display ${size} ${className}`}>
        <div 
          className="rank-badge"
          style={{ '--rank-color': progress.currentRank.color } as React.CSSProperties}
        >
        ...
        <div className="rank-info">
          ...
          <div className="rank-level">Rank {progress.currentRank.level}</div>
        </div>
        
        {showProgress && progress.nextRank && (
          <div className="rank-progress">
            <div className="progress-header">
              <div className="current-points">{progress.currentPoints} points</div>
              <div className="next-rank">
                Next: <span className="highlight" style={{ color: progress.nextRank.color }}>
            ...
            <div className="progress-bar-container">
              ...
              ></div>
              <div className="progress-percentage">{progress.percentToNextRank}%</div>
            </div>
            ...
            <div className="progress-details">
              ...
              <div className="total-required">
                {progress.pointsInCurrentRank}/{progress.pointsForNextRank} points
              </div>
            </div>
          </div>
        )}
