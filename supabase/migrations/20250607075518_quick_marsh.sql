/*
  # Create scenario linkage tables for recommendations
  ...
  2. Security
    ...
    - Add policies for public read access (needed for recommendations)
    - Add policies for authenticated users to manage linkages (admin functionality)
